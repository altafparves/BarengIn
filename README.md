# BarengIn
Schedule-based social carpooling for university students — Junior Project (OOP & Databases), DTETI FT UGM.

## About the Project
BarengIn is a schedule-based carpooling and ride-sharing platform built specifically for university students in Indonesia. By matching students' class schedules and destination faculties.
...
## Similar Apps
Gojek/GoCar, Grab, BlaBlaCar — BarengIn differentiates on schedule-based matching, social profiles, and a campus-specific climate impact dashboard.

## Project Status
In development — Module 1 (concept, repo setup, GitHub Page) in progress. Architecture and API design next.
